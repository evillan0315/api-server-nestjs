...
export class GeminiContentsDto {
  @ApiProperty({
    description: 'An array of parts containing the text to be processed by the Gemini model.',
...
export class GeminiDto {
  @ApiProperty({
    description: 'The contents array that contains the text to be processed by the Gemini model.',
